...
module.exports.handleEvent = async function ({ api, event }) {
    if (!(event.body.indexOf("bot") === 0 || event.body.indexOf("Bot") === 0)) return;
    ...
    try {
        const res = await axios.get(`https://raw.githubusercontent.com/MOHAMMAD-NAYAN/Nayan/main/api.json`);
